...
import { Save, Search, Tag, Lightbulb, AlertTriangle, Target, Star, MessageSquare, Mic, Plus, X } from 'lucide-react';
...
const NotesManager: React.FC<NotesManagerProps> = ({ selectedDate }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Enhanced Voice Notes and Media Section */}
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-6 border border-amber-200/50 dark:border-gray-600/50">
        <h4 className="font-bold text-gray-900 dark:text-white mb-4 flex items-center">
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-2.5 rounded-xl shadow-lg mr-3">
            <Mic className="h-5 w-5 text-white" />
          </div>
          Voice Notes & Media
        </h4>
        <div className="text-center py-8">
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-4 rounded-2xl w-fit mx-auto mb-4 opacity-50">
