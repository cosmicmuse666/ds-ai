...
const CalendarView: React.FC = () => {
  ...
  return (
    <div className="space-y-10 animate-fade-in">
      ...
      <div className="calendar-section-spacing">
      ...
      {/* Enhanced Calendar Section with Perfect Spacing */}
      <div className="calendar-section-spacing">
        <div className="glass-card rounded-3xl shadow-xl overflow-hidden calendar-main-container">
          <div className="calendar-container calendar-perfect-spacing">
            {/* Header Section */}
            ...
            {/* Visual separator */}
            <div className="border-t border-palette-medium-orchid/20 calendar-section-spacing"></div>

            {/* Day Names Header with Perfect Spacing */}
            <div className="calendar-day-names calendar-equal-margins">
              {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                <div key={day} className="calendar-day-name calendar-balanced-grid">
                  {day}
                </div>
              ))}
            </div>

            {/* Enhanced Calendar Grid with Perfect Spacing */}
            <div className="calendar-grid-wrapper">
              <div className="calendar-grid calendar-equal-margins">
                {/* Empty cells for month start alignment */}
                {Array.from({ length: monthStart.getDay() }).map((_, index) => (
                  <div key={`empty-${index}`} className="calendar-cell calendar-perfect-spacing"></div>
                ))}
                
                {/* Date cells with perfect spacing */}
                {daysInMonth.map(date => {
                  ...
                  return (
                    <div
                      ...
                      className={`calendar-cell calendar-cell-enter calendar-perfect-spacing ${
                        isTodayDate ? 'calendar-cell-today' :
                        isCurrentMonth ? 'calendar-cell-current-month' : 'calendar-cell-other-month'
                      }`}
                      onClick={() => handleDateClick(date)}
                    >
                      <div className="calendar-cell-content calendar-balanced-grid">
            ...
            {/* Enhanced Legend with Perfect Spacing */}
      ...
      {/* Two-Column Layout Below Calendar with Perfect Spacing */}
      <div className="calendar-section-spacing">
